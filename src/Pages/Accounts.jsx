...
function Accounts() {
  ...
  // Redirect to login if userData is null or undefined
  useEffect(() => {
    if (!userData) {
        ...
        <div class="col-span-9 grid grid-cols-3 gap-4">
          <div class="shadow rounded bg-white px-4 pt-6 pb-8">
            ...
            <div class="space-y-1">
              ...
              <p class="text-gray-800">{userDetail.email}</p>
              <p class="text-gray-800">{userDetail.phone_number}</p>
            </div>
          </div>
          ...
          <div class="shadow rounded bg-white px-4 pt-6 pb-8">
            ...
            <div class="space-y-1">
              ...
              <p class="text-gray-800">{userDetail.address_line_1}</p>
              <p class="text-gray-800">{userDetail.city}</p>
              <p class="text-gray-800">{userDetail.state}</p>
              <p class="text-gray-800">{userDetail.postal_code}</p>
            </div>
          </div>
        </div>
      </div>
